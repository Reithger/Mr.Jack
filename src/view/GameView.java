...
import model.game.DrawnTile;
import view.visualmechanics.InteractFrame;
import view.visualmechanics.TimerRefresh;
...
//---  Constant Values   ----------------------------------------------------------------------
    ...
    private static final String[] TITLE_MENU_TEXT = {"Mr.Jack", "A Game", "(By Ada and Sarah)", "(And Sienna)"};
